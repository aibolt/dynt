...
Both engines will start with the browser DOM as their shared platform contract. A developer will initialize an engine once with selectors and configuration; DYNT will enhance matching existing and future elements without requiring component-by-component edits.

Framework adapters will only manage mounting and cleanup. They will not duplicate formation or kinetic behavior.
